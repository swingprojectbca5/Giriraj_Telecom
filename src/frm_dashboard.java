...
public class frm_dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_editcust.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_editcustActionPerformed(evt);
            }
        });
...
//        visibility(lbl_addpro, false, false, true, false, false, false, false);
    ...
    private void btn_editcustActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editcustActionPerformed

        fetchDataIntoTable(table_custedit, "customer");
    }//GEN-LAST:event_btn_editcustActionPerformed
    ...
    public void fetchDataIntoTable(JTable tablenm, String dbTablenm) {
        try {
            ...
            while (rs.next()) {
                ...
                String[] Row = {nm, contact, email, snm, sadd};
